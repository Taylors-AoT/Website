...
import {Github, Twitter, Linkedin, Instagram, FacebookIcon, Facebook} from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/Taylors-AoT/Website.git" target = "_blank" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-cyan-600 transition-colors">
                <Github className="w-5 h-5 text-gray-300 hover:text-white" />
              </a>
              <a href="https://www.facebook.com/AgentsOfTech?_rdc=1&_rdr" target = "_blank" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-cyan-600 transition-colors">
                <Facebook className="w-5 h-5 text-gray-300 hover:text-white" />
              </a>
              <a href="https://www.linkedin.com/company/tayloraot/posts/?feedView=all" target= "_bank" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-cyan-600 transition-colors">
                <Linkedin className="w-5 h-5 text-gray-300 hover:text-white" />
              </a>
              <a href="https://www.instagram.com/agentsoftech.tlc" target= "_bank" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-cyan-600 transition-colors">
