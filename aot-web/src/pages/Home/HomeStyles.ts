export const styles = {
    ...
    statNumber: "text-4xl font-extrabold font-mono text-white mb-2",
    statLabel: "text-xs text-gray-400 uppercase tracking-widest font-mono",

    // Why Join Section
    featuresSection: "w-full max-w-7xl mx-auto px-4 py-24",
    featuresTitle: "text-3xl md:text-4xl font-bold font-heading text-center mb-16",
    ...
    featureIconWrapper: "w-16 h-16 flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110",
    featureIcon: "w-16 h-16 object-contain mix-blend-screen",
    featureCardTitle: "text-xl font-bold font-heading text-white mb-3",
