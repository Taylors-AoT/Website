export const styles = {
    ...
    title: "text-4xl md:text-5xl font-bold font-heading text-white mb-4",
    ...
    cardIcon: "w-16 h-16 object-contain mix-blend-screen mb-4",
    cardTitle: "text-xl font-bold font-heading text-white mb-3",
    ...
    navIconWrapper: "w-16 h-16 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 z-10",
    navTitle: "text-2xl font-bold font-heading text-white mb-2 z-10 group-hover:text-cyan-400 transition-colors",
    navDesc: "text-gray-400 text-center mb-4 z-10 max-w-sm",
    navLink: "text-cyan-400 text-sm font-bold flex items-center z-10 opacity-80 group-hover:opacity-100 font-mono tracking-wide",
    ...
    teamSectionTitle: "text-3xl md:text-4xl font-bold font-heading text-white mb-4",
    ...
    teamHubIconWrapper: "w-16 h-16 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 z-10",
    teamHubTitle: "text-3xl font-bold font-heading text-white mb-2 group-hover:text-cyan-400 transition-colors z-10",
    teamHubDesc: "text-gray-400 text-center group-hover:text-gray-300 z-10",
    teamHubLink: "mt-6 text-cyan-400 flex items-center text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity z-10 font-mono tracking-wide"
};